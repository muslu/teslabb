...
class UAgentInfo( object ):
	...
	def detectSmartphone( self ):
		...
		"""
		return self.detectTierIphone( ) or self.detectS60OssBrowser( ) or self.detectSymbianOS( ) or self.detectWindowsMobile( ) or self.detectBlackBerry( ) or self.detectPalmWebOS( )
	...
	def detectMobileQuick( self ):
		...
		if UAgentInfo.engineObigo in self.__userAgent or UAgentInfo.engineNetfront in self.__userAgent or UAgentInfo.engineUpBrowser in self.__userAgent or UAgentInfo.engineOpenWeb in self.__userAgent:
			return True

		if self.detectDangerHiptop( ) or self.detectMidpCapable( ) or self.detectMaemoTablet( ) or self.detectArchos( ):
			return True

		if UAgentInfo.devicePda in self.__userAgent and UAgentInfo.disUpdate not in self.__userAgent:
			return True
	...
	def detectTierIphone( self ):
		...
		return self.detectIphoneOrIpod( ) or self.detectAndroidPhone( ) or self.detectWindowsPhone( ) or self.detectBlackBerry10Phone( ) or self.detectBlackBerryWebKit( ) and self.detectBlackBerryTouch( ) or self.detectPalmWebOS( ) or self.detectBada( ) or self.detectTizen( ) or self.detectGamingHandheld( )
